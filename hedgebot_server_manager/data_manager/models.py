...
class risk_management_user_input_table(models.Model):
    ...
    anhydrous_revenes = models.FloatField()
    ...
    anhydrous_revenes_var = models.FloatField()
    ...
    anhydrous_revenes_at_market = models.FloatField()
    ...
    anhydrous_revenes_upper = models.FloatField()
    ...
    anhydrous_revenes_lower = models.FloatField()
