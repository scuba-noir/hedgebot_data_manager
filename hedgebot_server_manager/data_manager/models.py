...
class current_financial_simulations(models.Model):
    ...
    short_term_debt = models.FloatField(default=0, verbose_name='Short Term Debt Percent')
    current_ratio = models.FloatField(default=0, verbose_name='Current Ratio')
    sugar_price_std= models.FloatField(default=0, verbose_name='Sugar')
    hydrous_price_std= models.FloatField(default=0, verbose_name='Hydrous')
    anhydrous_price_std= models.FloatField(default=0, verbose_name ='Anhydrous')
    energy_price_std= models.FloatField(default=0, verbose_name='Energy')
    fx_rate_std= models.FloatField(default=0, verbose_name='Exchange rate')
    selic_rate_std= models.FloatField(default=0, verbose_name = 'Domestic interest rate')
    foreign_debt_rate_std= models.FloatField(default=0, verbose_name = 'Foreign interest rate')
    inflation_rate_std= models.FloatField(default=0, verbose_name = 'Inflation')
    crude_price_std= models.FloatField(default=0, verbose_name='Crude oil')
    fertilizer_price_std= models.FloatField(default=0, verbose_name='Fertilizers')
    sugar_revenues_std= models.FloatField(default=0, verbose_name='Sugar Revenues BRL')
    hydrous_revenues_std= models.FloatField(default=0, verbose_name='Hydrous Revenues BRL')
    anhydrous_revenues_std= models.FloatField(default=0, verbose_name ='Anhydrous Revenues BRL')
    energy_revenues_std= models.FloatField(default=0, verbose_name='Energy Revenues BRL')
    input_costs_std= models.FloatField(default=0, verbose_name='Input Cost BRL')
    fuel_costs_std= models.FloatField(default=0, verbose_name='Fuel Cost BRL')
    freight_costs_std= models.FloatField(default=0, verbose_name='Freight Cost BRL')
    labor_costs_std= models.FloatField(default=0, verbose_name='Labor Cost BRL')
    indutrial_costs_std= models.FloatField(default=0, verbose_name='Industrial Cost BRL')
    depreciation_std= models.FloatField(default=0, verbose_name='Depreciation BRL')
    planting_costs_std= models.FloatField(default=0, verbose_name='Planting Cost BRL')
    lease_costs_std= models.FloatField(default=0, verbose_name='Lease Cost BRL')
    gross_profit_std= models.FloatField(default=0, verbose_name='Gross Profit BRL')
    sga_costs_std= models.FloatField(default=0, verbose_name='Total SG&A BRL')
    ebit_std= models.FloatField(default=0, verbose_name='EBIT')
    financial_costs_std= models.FloatField(default=0, verbose_name='Financial Expenses BRL')
    ebt_std= models.FloatField(default=0, verbose_name='Profit Before Tax BRL')
    tax_std= models.FloatField(default=0, verbose_name='Income Tax BRL')
    net_income_std= models.FloatField(default=0, verbose_name='Net Income BRL')
    gross_margin_std= models.FloatField(default=0, verbose_name='Gross Margin')
    ebitda_margin_std= models.FloatField(default=0, verbose_name='EBITDA Margin')
    net_margin_std= models.FloatField(default=0, verbose_name='Net Margin')
    net_debt_to_ebitda_std= models.FloatField(default=0, verbose_name='Net Debt / EBITDA')
    net_debt_to_mt_cane_std= models.FloatField(default=0, verbose_name='Net Debt / MT of Cane')
    indebtness_std= models.FloatField(default=0, verbose_name='Indebtness')
    short_term_debt_std= models.FloatField(default=0, verbose_name='Short Term Debt Percent')
    current_ratio_std= models.FloatField(default=0, verbose_name='Current Ratio')