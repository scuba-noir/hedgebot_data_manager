...
class risk_management_user_input_table(models.Model):
    ...
    anhydrous_revenues = models.FloatField()
    ...
    anhydrous_revenues_var = models.FloatField()
    ...
    anhydrous_revenues_at_market = models.FloatField()
    ...
    anhydrous_revenues_upper = models.FloatField()
    ...
    anhydrous_revenues_lower = models.FloatField()
