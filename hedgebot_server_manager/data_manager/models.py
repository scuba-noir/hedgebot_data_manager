...
class current_financial_simulations(models.Model):
    ...
    planting_costs = models.FloatField(default=0, verbose_name='Planting Cost BRL')
    lease_costs = models.FloatField(default=0, verbose_name='Lease Cost BRL')
    cogs = models.FloatField(default = 0, verbose_name = "Cost of Goods Sold BRL")
    gross_profit = models.FloatField(default=0, verbose_name='Gross Profit BRL')
    sga_costs = models.FloatField(default=0, verbose_name='Total SG&A BRL')
    ebit = models.FloatField(default=0, verbose_name='EBIT')
    financial_costs = models.FloatField(default=0, verbose_name='Financial Expenses BRL')
    ...
    short_term_debt = models.FloatField(default=0, verbose_name='Short Term Debt Percent')
    current_ratio = models.FloatField(default=0, verbose_name='Current Ratio')
    sugar_price_std= models.FloatField(default=0, verbose_name='Sugar_std')
    hydrous_price_std= models.FloatField(default=0, verbose_name='Hydrous_std')
    anhydrous_price_std= models.FloatField(default=0, verbose_name ='Anhydrous_std')
    energy_price_std= models.FloatField(default=0, verbose_name='Energy_std')
    fx_rate_std= models.FloatField(default=0, verbose_name='Exchange rate_std')
    selic_rate_std= models.FloatField(default=0, verbose_name = 'Domestic interest rate_std')
    foreign_debt_rate_std= models.FloatField(default=0, verbose_name = 'Foreign interest rate_std')
    inflation_rate_std= models.FloatField(default=0, verbose_name = 'Inflation_std')
    crude_price_std= models.FloatField(default=0, verbose_name='Crude oil_std')
    fertilizer_price_std= models.FloatField(default=0, verbose_name='Fertilizers_std')
    sugar_revenues_std= models.FloatField(default=0, verbose_name='Sugar Revenues BRL_std')
    hydrous_revenues_std= models.FloatField(default=0, verbose_name='Hydrous Revenues BRL_std')
    anhydrous_revenues_std= models.FloatField(default=0, verbose_name ='Anhydrous Revenues BRL_std')
    energy_revenues_std= models.FloatField(default=0, verbose_name='Energy Revenues BRL_std')
    input_costs_std= models.FloatField(default=0, verbose_name='Input Cost BRL_std')
    fuel_costs_std= models.FloatField(default=0, verbose_name='Fuel Cost BRL_std')
    freight_costs_std= models.FloatField(default=0, verbose_name='Freight Cost BRL_std')
    labor_costs_std= models.FloatField(default=0, verbose_name='Labor Cost BRL_std')
    indutrial_costs_std= models.FloatField(default=0, verbose_name='Industrial Cost BRL_std')
    depreciation_std= models.FloatField(default=0, verbose_name='Depreciation BRL_std')
    planting_costs_std= models.FloatField(default=0, verbose_name='Planting Cost BRL_std')
    lease_costs_std= models.FloatField(default=0, verbose_name='Lease Cost BRL_std')
    cogs_std = models.FloatField(default = 0, verbose_name = "Cost of Goods Sold BRL_std")    
    gross_profit_std= models.FloatField(default=0, verbose_name='Gross Profit BRL_std')
    sga_costs_std= models.FloatField(default=0, verbose_name='Total SG&A BRL_std')
    ebit_std= models.FloatField(default=0, verbose_name='EBIT_std')
    financial_costs_std= models.FloatField(default=0, verbose_name='Financial Expenses BRL_std')
    ebt_std= models.FloatField(default=0, verbose_name='Profit Before Tax BRL_std')
    tax_std= models.FloatField(default=0, verbose_name='Income Tax BRL_std')
    net_income_std= models.FloatField(default=0, verbose_name='Net Income BRL_std')
    gross_margin_std= models.FloatField(default=0, verbose_name='Gross Margin_std')
    ebitda_margin_std= models.FloatField(default=0, verbose_name='EBITDA Margin_std')
    net_margin_std= models.FloatField(default=0, verbose_name='Net Margin_std')
    net_debt_to_ebitda_std= models.FloatField(default=0, verbose_name='Net Debt / EBITDA_std')
    net_debt_to_mt_cane_std= models.FloatField(default=0, verbose_name='Net Debt / MT of Cane_std')
    indebtness_std= models.FloatField(default=0, verbose_name='Indebtness_std')
    short_term_debt_std= models.FloatField(default=0, verbose_name='Short Term Debt Percent_std')
    current_ratio_std= models.FloatField(default=0, verbose_name='Current Ratio_std')

class risk_management_user_input_table(models.Model):

    sugar_price = models.FloatField()
    sugar_price_var = models.FloatField()
    sugar_price_at_market = models.FloatField()
    sugar_price_upper = models.FloatField()
    sugar_price_lower = models.FloatField()
    hydrous_price = models.FloatField()
    hydrous_price_var = models.FloatField()
    hydrous_price_at_market = models.FloatField()
    hydrous_price_upper = models.FloatField()
    hydrous_price_lower = models.FloatField()    
    anhydrous_price = models.FloatField()
    anhydrous_price_var = models.FloatField()
    anhydrous_price_at_market = models.FloatField()
    anhydrous_price_upper = models.FloatField()
    anhydrous_price_lower = models.FloatField()        
    fx_rate = models.FloatField()
    fx_rate_var = models.FloatField()
    fx_rate_at_market = models.FloatField()
    fx_rate_upper = models.FloatField()
    fx_rate_lower = models.FloatField()        
    sugar_revenues = models.FloatField()
    hydrous_revenues = models.FloatField()
    anhydrous_revenes = models.FloatFields()
    cogs = models.FloatField()
    gross_profit = models.FloatField()
    sga_costs = models.FloatField()
    ebit = models.FloatField()
    financial_costs = models.FloatField()
    net_income = models.FloatField()
    sugar_revenues_var = models.FloatField()
    hydrous_revenues_var = models.FloatField()
    anhydrous_revenes_var = models.FloatFields()
    cogs_var = models.FloatField()
    gross_profit_var = models.FloatField()
    sga_costs_var = models.FloatField()
    ebit_var = models.FloatField()
    financial_costs_var = models.FloatField()
    net_income_var = models.FloatField()
    sugar_revenues_at_market = models.FloatField()
    hydrous_revenues_at_market = models.FloatField()
    anhydrous_revenes_at_market = models.FloatFields()
    cogs_at_market = models.FloatField()
    gross_profit_at_market = models.FloatField()
    sga_costs_at_market = models.FloatField()
    ebit_at_market = models.FloatField()
    financial_costs_at_market = models.FloatField()
    net_income_at_market = models.FloatField()
    sugar_revenues_upper = models.FloatField()
    hydrous_revenues_upper = models.FloatField()
    anhydrous_revenes_upper = models.FloatFields()
    cogs_upper = models.FloatField()
    gross_profit_upper = models.FloatField()
    sga_costs_upper = models.FloatField()
    ebit_upper = models.FloatField()
    financial_costs_upper = models.FloatField()
    net_income_upper = models.FloatField()
    sugar_revenues_lower = models.FloatField()
    hydrous_revenues_lower = models.FloatField()
    anhydrous_revenes_lower = models.FloatFields()
    cogs_lower = models.FloatField()
    gross_profit_lower = models.FloatField()
    sga_costs_lower = models.FloatField()
